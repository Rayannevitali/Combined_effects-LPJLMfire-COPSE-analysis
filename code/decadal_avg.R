...
decadalavg_mdf <- function(file, var, npft=0, path="code"){
  ...
  if(var == "cover" || var == "pftalbiomass" || var == "forestcov" || var == "height"){pcheck=TRUE}else{pcheck=FALSE}                  # check if variable includes PFT dimensions
